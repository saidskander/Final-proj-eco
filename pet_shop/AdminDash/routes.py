...
def NewBrand():  # 4
    ...
    return render_template('newbrand.html', brand_form="brand_form", form=form)  # 4
...
def NewCategory():  # 4
    ...
    return render_template('newbrand.html', form=form, categ="categ")  # 4
...
def NewCategory():  # 4
    ...
    if request.method == 'POST':  # 4
        ...
        flash("plz add the forms")  # 4
    return render_template('newbrand.html', title="newcateg", form=form)  # 4
